...
根元素、position 分层、transform、半透明、CSS 滤镜、canvas、video、overflow
...
什么因素产生重排：offset、scroll、client、width 、读属性
...
cpu 主要负责操作系统和程序 gpu 负责显式 数据处理 效率更高 gpu.js

4.https://www.npmjs.com/package/fastdom
